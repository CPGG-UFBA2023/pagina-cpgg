          ...
          <div className={`${styles.box} ${showRequest ? styles.boxFullWidth : ''}`}>
            {!showRequest && (
              <div className={styles.photoGrid}>
                ...
                >
                  <h4 className={styles.legend1}>{photos.photo1_legend || 'Difratômetro de Raios X (DRX) BRUKER AXS, modelo D2 PHASER, para análise de fases em estudos de materiais. Energia: 8 Kev/ 30 KV máxima/corrente: 10mA.'}</h4>
                </div>
                <div
                ...
                >
                  <h4 className={styles.legend2}>{photos.photo2_legend || 'Espectrômetro de Fluorescência (WDX-FRX) por dispersão de comprimento de onda – BRUKER AXS, modelo S8 TIGER, para análise de elementos químicos. Energia: 20,2 Kev/60KV máxima/corrente: 170mA.'}</h4>
                </div>
              </div>
            )}
            <div className={styles.content}>
              <ul>LTM-RX</ul>
              <a className={styles.subtitle}>Laboratório de Tecnologia Mineral - Raios X</a>
