        ...
        <div className={styles.Title} >
          ...
          <a>Laboratório de Espectrometria de Massas de Alta Resolução</a>
           ...
           <span style={{ fontSize: '64%' }}><a href="mailto:guimaraesleticia@ufba.br" className={styles.purpleLink}>guimaraesleticia@ufba.br</a></span>
            ...
            <div className={styles.photoBox2} style={{ backgroundImage: `linear-gradient(90deg, rgba(2,0,36,0.1) 0%, rgba(63,9,121,0.1)), url(${lemarPhoto2})` }}>
              <h4 className={styles.legend}>ICP-MS-segundo plano</h4>
            </div>
            <div className={styles.photoBox3} style={{ backgroundImage: `linear-gradient(90deg, rgba(2,0,36,0.1) 0%, rgba(63,9,121,0.1)), url(${lemarPhoto3})` }}>
