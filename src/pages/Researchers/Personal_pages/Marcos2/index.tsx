import styles from './Marcos2.module.css'
    ...
    <div className={styles.Container}>
      ...
      <div>
        <div className={styles.Professor} >
          <BackButton />
          <p> Marcos Vasconcelos2 </p>
          <div className={styles.box1}>
          <DynamicResearcherProfile 
            researcherName="Marcos Vasconcelos2"
            ...
            belowPhoto={<ResearcherEditButton researcherName="Marcos Vasconcelos2" inline />}
          />
            <nav>
