      ...
      <div>
        <div className={styles.Professor} >
          ...
          <DynamicResearcherProfile 
            ...
            belowPhoto={<ResearcherEditButton researcherName="Camila Brasil Louro da Silveira" staticDescription={`Sou oceanógrafa, Professora Adjunta do Departamento de Oceanografia na Universidade Federal da Bahia. Tenho grau de Doutorado e Mestrado em Oceanografia pela Universidade Federal de Pernambuco. Atuo na área de monitoramento, mapeamento e conservação, sensoriamento remoto e geoprocessamento aplicado ao ambiente marinho e costeiro, principalmente em recifes de coral, e na obtenção e tratamento de dados de campo. Possui experiência em expedições Reef Check Brasil na APA Costa dos Corais (PE/AL), PARNAMAR Fernando de Noronha, PARNAMAR Abrolhos, entre outras.`} inline />}
          />
