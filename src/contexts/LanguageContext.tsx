...
const translations = {
  pt: {
    ...
    'production.heading': 'Produção Científica',
    ...
    'senior.title': 'Pesquisadores Seniores',
    'senior.description': 'A denominação “pesquisador sênior” foi normatizada pelo Conselho Científico em 2023, com a aprovação da Deliberação Normativa 02/2023, que define os critérios para essa classificação.',
    'history.formerCoordinators': 'Coordenadores do CPGG',
    'history.present': 'atual',
    'history.documentTitle': 'História do CPGG',
    'history.documentLoading': 'Carregando documento…',
    'history.documentError': 'Não foi possível exibir o documento.',
    'history.openNewTab': 'Abrir em nova aba',
    'history.protectedNotice': 'Este documento é protegido. Cópia, download e impressão estão desabilitados.',
    'archive.title': 'Arquivo de Notícias',
    'archive.subtitle': 'Todas as notícias publicadas no CPGG',
    'archive.total': 'no total',
    'archive.empty': 'Nenhuma notícia encontrada.',
    'archive.pagination': 'Paginação de notícias',
    'archive.previous': 'Página anterior',
    'archive.next': 'Próxima página',
    'news.notFound': 'Notícia não encontrada',
    'news.notFoundMessage': 'Esta notícia não existe ou foi removida.',
    'news.externalLink': 'Acessar link externo',
    'news.downloadPdf': 'Baixar PDF',
    ...
    'history.instituteTitle': 'Histórico Com o Instituto de Geociências',
    'history.instituteCard': 'Histórico Com o Instituto de Geociências',
    'history.docsSedeCard': 'Documentos da Construção da Sede do CPGG',
    'history.docsSedeTitle': 'Documentos da Construção da Sede do CPGG',
    'history.docsSede.doc1': 'Ofício 066/2009 e Plano de Trabalho do Projeto Sede do CPGG',
    'history.docsSede.doc1.desc': 'Resubmissão do projeto de infraestrutura à PETROBRAS, Termo de Recebimento Definitivo da parte térrea (2010) e plano de trabalho completo.',
    'history.docsSede.doc2': 'Declaração do Reitor (2009)',
    'history.docsSede.doc2.desc': 'Declaração da Reitoria da UFBA de que o prédio anexo ao Instituto de Geociências se destina à infraestrutura física do CPGG.',
    'history.docsSede.doc3': 'Relatório Técnico Final — Convênio PETROBRAS',
    'history.docsSede.doc3.desc': 'Relatório final do projeto de conclusão da infraestrutura física do CPGG, com fotos da obra e resultados obtidos.',
    'history.docsSede.doc4': 'Termo de Recebimento Definitivo (2013)',
    'history.docsSede.doc4.desc': 'Recebimento definitivo da obra de construção de um andar e meio da sede, com relatório técnico e quadros de áreas.',
    'history.institute.p1': 'Após a inauguração do bloco D em 13/fev/1981, algumas das suas salas passaram a ser administradas pelo PPPG, as quais não constituíam, em sua origem em salas de aulas. Os espaços destinaram-se à acomodação de diversas atividades, destacando-se: (a) laboratório de manutenção dos equipamentos de geofísica de campo e laboratoriais; (b) almoxarifados de equipamentos; (c) sistema computacional de médio porte para a época, constituído no sistema DISCO&VAX11/780 incluindo unidades de fita magnética de rolo, unidades para a plotagem de grandes seções sísmicas, impressoras de impacto e outros periféricos, com desempenho superior ao sistema computacional central (DEC10) localizado no CPD/UFBA; (d) laboratório de propriedades físicas da rochas; (e) laboratório para modelagem geofísica com técnicas de modelo reduzido; (f) espaço para produção gráfica composto de impressora “off-set” e câmara escura com equipamento para a produção de fotolitos (fotográfica) para a produção de matrizes de impressão; (g) sala de pessoal de suporte computacional (h) sala de terminais incluindo de tipo gráfico (inédito para época); (i) sala de estudos para a acomodação dos alunos do Curso de Pós-graduação em Geofísica e espaços correlatos.',
    'history.institute.p2': 'Posteriormente, esses espaços foram sendo adaptados para outras necessidades, destacando-se: (a) sala de manutenção mecânica; (b) sala para o desenvolvimento de projeto com a ANP para o processamento/análise dos dados geológicos e geofísicos referentes à bacia Recôncavo; (c) substituição do sistema VAX por servidores baseados em máquinas IBM, Sun e microcomputadores em geral, formando conjuntos para processamento de alto desempenho e periféricos tais como impressoras a jato de tinta, a laser preto e branco, a laser colorida, plotter de pena tamanho A0 e de jato de tinta tamanho A0; (d) salas para acomodação da microssonda eletrônica e preparo de amostras; (e) sala de estudos de alunos de iniciação científica do curso de graduação em geofísica; (f) sala de professores; (g) sala de visualização 3d.',
    'history.institute.p3': 'Com a construção da Sede do CPGG, as atividades administrativas do PPPG/CPGG, do Colegiado do Curso de Pós-graduação em Geofísica e sala de professores foram transferidas para esse novo bloco e os espaços passaram a se ocupados pela secretarias do Curso de Pós-graduação em Geografia, do Curso de Pós-graduação em Geologia e docentes do Departamento de Geografia. Após a realocação da sala estudos para a acomodação dos alunos do Curso de Pós-graduação em Geofísica para o novo prédio, o espaço original foi transformado em duas sala de aula informatizadas, equipadas com microcomputadores ou terminais, exigindo a instalação de rede de informática e equipamentos de apoio, além de quadros brancos e projetores fixados no teto. Neste processo de reordenamento do espaço físico do bloco D, foram adaptadas quatro espaços como novas salas de aulas tendo em vista as disciplinas dos currículos dos cursos de graduação e de pós-graduação em geofísica, especialmente aquelas lotadas nos departamentos de Geofísica (GEO) e Geofísica da Terra e Meio Ambiente (FIS), visando a melhoria dos aspectos didáticos, exigindo investimentos em projetores fixados no teto, aparelhos de ar condicionado e quadros brancos.',
    'history.institute.p4': 'Entre as contribuições do PPPG/CPGG destacam-se: (a) a instalação da primeira fibra ótica do IGEO ao CPD/UFBA, permitindo que toda a comunidade do IGEO passasse a ter acesso à Internet/RNP; (b) apoio com ferramentas e soluções e consultorias técnicas (especialmente na informática, incluindo questões de rede internet e equipamentos); (c) empréstimos de carrinhos, escadas, compressores de ar, etc.',
    'history.institute.p5': 'Com os recursos do projeto referente à Rodada 0 da ANP: (a) instalou-se tanto a primeira central telefônica no IGEO com tecnologia denominada DDR (discada direta a ramal), inédita na UFBA, projetou-se e executou-se a instalação da rede dos cabeamentos para os ramais telefônicos, melhorando significativamente o acesso telefônico externo a todos os departamentos, colegiados de curso e muitos professores; (b) apoiou-se a reforma do atual Auditório Profa. Yeda Ferreira com a reforma do piso de madeira troca de novas cadeiras, já substituídas; e (c) adquiriu-se uma copiadora de alto desempenho que ficou instalada e atuando na recepção da antiga biblioteca do IGEO no último andar no bloco D, para atender os usuários de uma forma geral.',
    'history.institute.p6': 'Ao longo do tempo e de menor monta mas de interesse coletivo, foi instalado o primeiro projetor fixo no Auditório Profa. Yeda Ferreira, e foram executadas (a) a instalação do portão após a entradas dos auditórios A e B para limitar o acesso a outras dependências do anexo do bloco A, (b) a instalação do portão no piso térreo do bloco C, impedindo o acesso aos andares superiores, e (c) a reforma da sala de aula 102-B.',
  ...
  en: {
    ...
    'production.heading': 'Scientific Publications',
    ...
    'senior.title': 'Senior Researchers',
    'senior.description': 'The “senior researcher” designation was established by the Scientific Council in 2023 through Normative Resolution 02/2023, which defines the criteria for this classification.',
    'history.formerCoordinators': 'Former CPGG Coordinators',
    'history.present': 'present',
    'history.documentTitle': 'History of CPGG',
    'history.documentLoading': 'Loading document…',
    'history.documentError': 'The document could not be displayed.',
    'history.openNewTab': 'Open in a new tab',
    'history.protectedNotice': 'This document is protected. Copying, downloading and printing are disabled.',
    'archive.title': 'News Archive',
    'archive.subtitle': 'All news published by CPGG',
    'archive.total': 'in total',
    'archive.empty': 'No news articles found.',
    'archive.pagination': 'News pagination',
    'archive.previous': 'Previous page',
    'archive.next': 'Next page',
    'news.notFound': 'News article not found',
    'news.notFoundMessage': 'This news article does not exist or has been removed.',
    'news.externalLink': 'Open external link',
    'news.downloadPdf': 'Download PDF',
    ...
    'history.instituteTitle': 'Histórico Com o Instituto de Geociências',
    'history.instituteCard': 'History of the Institute of Geosciences',
    'history.docsSedeCard': 'Documents of the Construction of the CPGG Headquarters',
    'history.docsSedeTitle': 'Documents of the Construction of the CPGG Headquarters',
    'history.docsSede.doc1': 'Ofício 066/2009 e Plano de Trabalho do Projeto Sede do CPGG',
    'history.docsSede.doc1.desc': 'Resubmissão do projeto de infraestrutura à PETROBRAS, Termo de Recebimento Definitivo da parte térrea (2010) e plano de trabalho completo.',
    'history.docsSede.doc2': 'Declaração do Reitor (2009)',
    'history.docsSede.doc2.desc': 'Declaração da Reitoria da UFBA de que o prédio anexo ao Instituto de Geociências se destina à infraestrutura física do CPGG.',
